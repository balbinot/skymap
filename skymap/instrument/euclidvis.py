...
class VISFocalPlane(object):
    """Class for storing and manipulating the corners of the Euclid VIS camera.
    NOTE: corners are given for each quadrant of each CCD. There is not real
          gap between quadrants, only CCDs.
    """

    filename = os.path.join(get_datadir(),'VIS_ccds.dat')
